[< Return to Summary](summary.md) | File Generated: Mon Sep 21 2020 21:39:07 GMT+0000 (Coordinated Universal Time)

# availability-check >> availability-confirmed (ScheduledSession)
...
Response status code: 200 OK. Responded in 64.886355ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/60/events/604"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F60%2Fevents%2F604?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 17.701925ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-22T01:20:24+00:00",
    "endDate": "2020-09-22T05:29:24+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c7a4f31e-aba9-56be-b173-ed3e3e414e0c

---

Response status code: 200 OK. Responded in 77.759ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c7a4f31e-aba9-56be-b173-ed3e3e414e0c",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c7a4f31e-aba9-56be-b173-ed3e3e414e0c

---

Response status code: 200 OK. Responded in 61.755374ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
