[< Return to Summary](summary.md) | File Generated: Mon Sep 21 2020 21:39:00 GMT+0000 (Coordinated Universal Time)
...
⚠️ 24 passed with 0 failures, 330 warnings and 126 suggestions 
...
Response status code: 200 OK. Responded in 5.303919ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/77/events/776"
}
```
...
Response status code: 200 OK. Responded in 5.527833ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/56/events/566"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F77%2Fevents%2F776?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 9.241656ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-23T02:20:13+00:00",
    "endDate": "2020-09-23T06:41:13+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F56%2Fevents%2F566?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 8.845232ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/56",
      "name": "Fresh Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/56#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 0,
    ...
    "startDate": "2020-09-28T08:15:47+00:00",
    "endDate": "2020-09-28T10:20:47+00:00"
  }
}
```
### Specs
...
## Incomplete Broker Details at C1 >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b8dbad72-f05a-5514-9e84-a7b3ab7f7a77

---

Response status code: 400 Bad Request. Responded in 18.305293ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 6.163868ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/37/events/378"
}
```
...
Response status code: 200 OK. Responded in 5.584433ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/36/events/368"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F37%2Fevents%2F378?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 13.076881ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-25T04:20:41+00:00",
    "endDate": "2020-09-25T07:36:41+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F36%2Fevents%2F368?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 12.747461ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-23T09:06:28+00:00",
    "endDate": "2020-09-23T14:57:28+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b7ec92c0-130b-520b-9174-2fd151518687

---

Response status code: 200 OK. Responded in 67.0172ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b7ec92c0-130b-520b-9174-2fd151518687",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b7ec92c0-130b-520b-9174-2fd151518687

---

Response status code: 400 Bad Request. Responded in 10.857548ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
...
Response status code: 200 OK. Responded in 13.116283ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/26/events/260"
}
```
...
Response status code: 200 OK. Responded in 12.528148ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/65/events/654"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F26%2Fevents%2F260?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 5.621735ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-30T23:37:24+00:00",
    "endDate": "2020-10-01T00:27:24+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F65%2Fevents%2F654?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 5.221012ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-29T09:59:31+00:00",
    "endDate": "2020-09-29T14:34:31+00:00"
  }
}
```
### Specs
...
## Incomplete Broker Details at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5d3ef99f-1412-5c53-87b0-506c352316ce

---

Response status code: 200 OK. Responded in 52.891957ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5d3ef99f-1412-5c53-87b0-506c352316ce",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5d3ef99f-1412-5c53-87b0-506c352316ce

---

Response status code: 200 OK. Responded in 136.408379ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:44:04+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5d3ef99f-1412-5c53-87b0-506c352316ce

---

Response status code: 400 Bad Request. Responded in 31.323055ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
