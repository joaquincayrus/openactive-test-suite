...
Response status code: 200 OK. Responded in 73.476085ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/79/events/798"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F79%2Fevents%2F798?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 16.833381ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-25T03:46:07+00:00",
    "endDate": "2020-09-25T08:02:07+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f73aea15-fca3-5f00-8429-961c0998289f

---

Response status code: 200 OK. Responded in 27.009175ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f73aea15-fca3-5f00-8429-961c0998289f",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f73aea15-fca3-5f00-8429-961c0998289f

---

Response status code: 200 OK. Responded in 46.11619ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:44:06+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f73aea15-fca3-5f00-8429-961c0998289f

---

Response status code: 400 Bad Request. Responded in 77.344677ms
```json
{
  "@context": "https://openactive.io/",
