...
⚠️ 11 passed with 0 failures, 114 warnings and 40 suggestions 
...
Response status code: 200 OK. Responded in 215.759254ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/72/events/728"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F72%2Fevents%2F728?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 31.588229ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/72",
      "name": "Metal Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/72#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-09-27T15:56:54+00:00",
    "endDate": "2020-09-27T20:36:54+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/69cf6370-5c49-51b9-9323-36ab8348b615

---

Response status code: 200 OK. Responded in 587.916737ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/69cf6370-5c49-51b9-9323-36ab8348b615",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/72"
        },
        "maximumAttendeeCapacity": 29,
        "remainingAttendeeCapacity": 29,
        "startDate": "2020-09-27T15:56:54+00:00",
...
Response status code: 200 OK. Responded in 13.141237ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/75/events/753"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F75%2Fevents%2F753?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 8.217523ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/75",
      "name": "Frozen Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/75#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 7.33,
    ...
    "startDate": "2020-09-28T07:10:49+00:00",
    "endDate": "2020-09-28T11:31:49+00:00"
  }
}
```
### Specs
...
Response status code: 200 OK. Responded in 82.108786ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/75"
        },
        "maximumAttendeeCapacity": 49,
        "remainingAttendeeCapacity": 49,
        "startDate": "2020-09-28T07:10:49+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/69cf6370-5c49-51b9-9323-36ab8348b615

---

Response status code: 200 OK. Responded in 59.703171ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/69cf6370-5c49-51b9-9323-36ab8348b615

---

Response status code: 200 OK. Responded in 281.797296ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/69cf6370-5c49-51b9-9323-36ab8348b615",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/69cf6370-5c49-51b9-9323-36ab8348b615#/orderedItems/6",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/75#/offers/0",
        "price": 7.33,
