...
# amending-order-quote >> amend-c1 (Multiple)
...
⚠️ 25 passed with 0 failures, 314 warnings and 120 suggestions 
...
Response status code: 200 OK. Responded in 7.75549ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/49/events/491"
}
```
...
Response status code: 200 OK. Responded in 7.042645ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/57/events/573"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F49%2Fevents%2F491?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 6.3324ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/49",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/49#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-10-01T12:52:21+00:00",
    "endDate": "2020-10-01T15:16:21+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F57%2Fevents%2F573?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 5.766764ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/57",
      "name": "Steel Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/57#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 0,
    ...
    "startDate": "2020-09-25T20:06:22+00:00",
    "endDate": "2020-09-26T00:22:22+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7e06cdf1-c1a1-53c5-8938-ba68b665b87f

---

Response status code: 200 OK. Responded in 74.534868ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7e06cdf1-c1a1-53c5-8938-ba68b665b87f",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/49"
        },
        "maximumAttendeeCapacity": 36,
        "remainingAttendeeCapacity": 36,
        "startDate": "2020-10-01T12:52:21+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/57"
        },
        "maximumAttendeeCapacity": 8,
        "remainingAttendeeCapacity": 8,
        "startDate": "2020-09-25T20:06:22+00:00",
...
Response status code: 200 OK. Responded in 27.45782ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/70/events/703"
}
```
...
Response status code: 200 OK. Responded in 5.203826ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/34/events/346"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F70%2Fevents%2F703?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 5.068517ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-22T09:05:52+00:00",
    "endDate": "2020-09-22T12:27:52+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F34%2Fevents%2F346?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 4.549885ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-26T12:36:24+00:00",
    "endDate": "2020-09-26T15:16:24+00:00"
  }
}
```
### Specs
...
Response status code: 200 OK. Responded in 42.693053ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7e06cdf1-c1a1-53c5-8938-ba68b665b87f

---

Response status code: 200 OK. Responded in 116.229821ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7e06cdf1-c1a1-53c5-8938-ba68b665b87f

---

Response status code: 200 OK. Responded in 155.384126ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/7e06cdf1-c1a1-53c5-8938-ba68b665b87f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7e06cdf1-c1a1-53c5-8938-ba68b665b87f#/orderedItems/25",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/70#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7e06cdf1-c1a1-53c5-8938-ba68b665b87f#/orderedItems/26",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/70#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7e06cdf1-c1a1-53c5-8938-ba68b665b87f#/orderedItems/27",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/34#/offers/0",
        "price": 7.77,
