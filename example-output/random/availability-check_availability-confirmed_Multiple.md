...
⚠️ 14 passed with 0 failures, 149 warnings and 60 suggestions 
...
Response status code: 200 OK. Responded in 7.107008ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/58/events/582"
}
```
...
Response status code: 200 OK. Responded in 6.409969ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/32/events/322"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F58%2Fevents%2F582?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 11.887582ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/58",
      "name": "Fresh Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/58#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-09-24T23:35:37+00:00",
    "endDate": "2020-09-25T02:48:37+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F32%2Fevents%2F322?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 11.417156ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-30T23:28:36+00:00",
    "endDate": "2020-10-01T04:37:36+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1ce8b18d-45af-5fc0-9019-4e0014555296

---

Response status code: 200 OK. Responded in 31.096086ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1ce8b18d-45af-5fc0-9019-4e0014555296",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/58"
        },
        "maximumAttendeeCapacity": 23,
        "remainingAttendeeCapacity": 23,
        "startDate": "2020-09-24T23:35:37+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1ce8b18d-45af-5fc0-9019-4e0014555296

---

Response status code: 200 OK. Responded in 107.832147ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:44:09+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
