...
# simple-book-free-opportunities >> with-erroneous-payment-property (Multiple)
...
⚠️ 10 passed with 0 failures, 156 warnings and 60 suggestions 
...
Response status code: 200 OK. Responded in 15.678507ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/37/events/374"
}
```
...
Response status code: 200 OK. Responded in 14.904562ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/42/events/420"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F37%2Fevents%2F374?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 8.217576ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-01T17:53:34+00:00",
    "endDate": "2020-10-01T18:43:34+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F42%2Fevents%2F420?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 7.852355ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-29T17:27:33+00:00",
    "endDate": "2020-09-29T20:08:33+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/572929fd-f6c3-583c-bf5b-f5e290cbc43a

---

Response status code: 200 OK. Responded in 34.986625ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/572929fd-f6c3-583c-bf5b-f5e290cbc43a",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/572929fd-f6c3-583c-bf5b-f5e290cbc43a

---

Response status code: 200 OK. Responded in 95.40428ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/572929fd-f6c3-583c-bf5b-f5e290cbc43a

---

Response status code: 400 Bad Request. Responded in 70.698961ms
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "Payment details were erroneously supplied for a free Order."
}
```
### Specs
* ✅ should return something
* ✅ should return 400, with an UnnecessaryPaymentDetailsError error
