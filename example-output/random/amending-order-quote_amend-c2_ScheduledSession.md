...
# amending-order-quote >> amend-c2 (ScheduledSession)
...
⚠️ 10 passed with 0 failures, 114 warnings and 40 suggestions 
...
Response status code: 200 OK. Responded in 170.794867ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/36/events/364"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F36%2Fevents%2F364?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 17.091598ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-27T16:17:06+00:00",
    "endDate": "2020-09-27T22:00:06+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7cd0f14a-aba8-5543-8aa5-b83f7388afdf

---

Response status code: 200 OK. Responded in 576.637719ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7cd0f14a-aba8-5543-8aa5-b83f7388afdf",
...
Response status code: 200 OK. Responded in 25.02078ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/55/events/556"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F55%2Fevents%2F556?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 4.014754ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/55",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/55#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 0,
    ...
    "startDate": "2020-09-27T14:44:49+00:00",
    "endDate": "2020-09-27T15:44:49+00:00"
  }
}
```
### Specs
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7cd0f14a-aba8-5543-8aa5-b83f7388afdf

---

Response status code: 200 OK. Responded in 94.938195ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:43:56+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/55"
        },
        "maximumAttendeeCapacity": 1,
        "remainingAttendeeCapacity": 1,
        "startDate": "2020-09-27T14:44:49+00:00",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7cd0f14a-aba8-5543-8aa5-b83f7388afdf

---

Response status code: 200 OK. Responded in 121.743988ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/7cd0f14a-aba8-5543-8aa5-b83f7388afdf",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7cd0f14a-aba8-5543-8aa5-b83f7388afdf#/orderedItems/6",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/55#/offers/0",
        "price": 0,
