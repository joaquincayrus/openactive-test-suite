...
# amending-order-quote >> amend-c2 (Multiple)

Feature Implemented: true

Run C1,C2 with X opportunities, then - with the same Order UUID - run C2 with Y opportunities, then runs B. The resulting Order should include confirmed bookings for only Y opportunities

---

⚠️ 22 passed with 0 failures, 308 warnings and 120 suggestions 
...
Response status code: 200 OK. Responded in 16.978963ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/69/events/693"
}
```
...
Response status code: 200 OK. Responded in 16.191315ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/44/events/447"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F69%2Fevents%2F693?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 59.655836ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/69",
      "name": "Fresh Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/69#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-09-26T03:24:06+00:00",
    "endDate": "2020-09-26T04:24:06+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F44%2Fevents%2F447?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 58.979895ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-29T22:14:39+00:00",
    "endDate": "2020-09-30T03:54:39+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/36a8f425-f93c-5a87-abbd-f1500462f342

---

Response status code: 200 OK. Responded in 53.214633ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/36a8f425-f93c-5a87-abbd-f1500462f342",
...
## First Attempt - C1 -> C2 >> C2 >> validation of C1
### Specs
* ✅ passes validation checks
...
Response status code: 200 OK. Responded in 23.063532ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/69/events/690"
}
```
...
Response status code: 200 OK. Responded in 14.123777ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/42/events/425"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F69%2Fevents%2F690?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 11.192195ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-29T04:49:53+00:00",
    "endDate": "2020-09-29T09:58:53+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F42%2Fevents%2F425?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 10.80047ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/42",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/42#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 0,
    ...
    "startDate": "2020-09-23T15:56:33+00:00",
    "endDate": "2020-09-23T21:41:33+00:00"
  }
}
```
### Specs
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/36a8f425-f93c-5a87-abbd-f1500462f342

---

Response status code: 200 OK. Responded in 76.034724ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/36a8f425-f93c-5a87-abbd-f1500462f342

---

Response status code: 200 OK. Responded in 141.67543ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/36a8f425-f93c-5a87-abbd-f1500462f342",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/36a8f425-f93c-5a87-abbd-f1500462f342#/orderedItems/28",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/69#/offers/0",
        "price": 8.41,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/36a8f425-f93c-5a87-abbd-f1500462f342#/orderedItems/29",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/69#/offers/0",
        "price": 8.41,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/36a8f425-f93c-5a87-abbd-f1500462f342#/orderedItems/30",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/42#/offers/0",
        "price": 0,
