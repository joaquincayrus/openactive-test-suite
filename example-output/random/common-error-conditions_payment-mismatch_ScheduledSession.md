...
# common-error-conditions >> payment-mismatch (ScheduledSession)
...
Response status code: 200 OK. Responded in 58.721924ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/66/events/667"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F66%2Fevents%2F667?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 20.158575ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-27T17:47:08+00:00",
    "endDate": "2020-09-27T19:46:08+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fe9c497f-5737-5e05-bbef-421db3ee515b

---

Response status code: 200 OK. Responded in 108.045901ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fe9c497f-5737-5e05-bbef-421db3ee515b",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fe9c497f-5737-5e05-bbef-421db3ee515b

---

Response status code: 200 OK. Responded in 54.24364ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/fe9c497f-5737-5e05-bbef-421db3ee515b

---

Response status code: 400 Bad Request. Responded in 63.004746ms
```json
{
  "@context": "https://openactive.io/",
...
```
### Specs
* ✅ should return a(n) TotalPaymentDueMismatchError
