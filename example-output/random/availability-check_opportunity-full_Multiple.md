...
⚠️ 14 passed with 0 failures, 161 warnings and 60 suggestions 
...
Response status code: 200 OK. Responded in 6.494188ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/11/events/111"
}
```
...
Response status code: 200 OK. Responded in 5.54223ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/25/events/255"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F11%2Fevents%2F111?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 14.756781ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-23T14:59:29+00:00",
    "endDate": "2020-09-23T17:55:29+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F25%2Fevents%2F255?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 14.269951ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-29T13:56:58+00:00",
    "endDate": "2020-09-29T18:57:58+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/30013a54-b905-58cb-aea8-03687a2dd107

---

Response status code: 409 Conflict. Responded in 26.539884ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/30013a54-b905-58cb-aea8-03687a2dd107",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/30013a54-b905-58cb-aea8-03687a2dd107

---

Response status code: 409 Conflict. Responded in 39.859279ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:44:03+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
