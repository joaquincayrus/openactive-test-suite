...
Response status code: 200 OK. Responded in 6.9065ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/52/events/525"
}
```
...
Response status code: 200 OK. Responded in 6.187658ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/26/events/269"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F52%2Fevents%2F525?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 14.241324ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-24T04:24:59+00:00",
    "endDate": "2020-09-24T05:44:59+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F26%2Fevents%2F269?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 13.904905ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-29T07:00:33+00:00",
    "endDate": "2020-09-29T07:42:33+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/64900abf-81df-5e95-8a81-2c952fb0f925

---

Response status code: 200 OK. Responded in 77.048725ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/64900abf-81df-5e95-8a81-2c952fb0f925",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/64900abf-81df-5e95-8a81-2c952fb0f925

---

Response status code: 200 OK. Responded in 91.836375ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/64900abf-81df-5e95-8a81-2c952fb0f925

---

Response status code: 400 Bad Request. Responded in 80.888725ms
```json
{
  "@context": "https://openactive.io/",
