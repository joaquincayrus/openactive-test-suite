[< Return to Summary](summary.md) | File Generated: Mon Sep 21 2020 21:39:10 GMT+0000 (Coordinated Universal Time)
...
Response status code: 200 OK. Responded in 7.369514ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/89/events/897"
}
```
...
Response status code: 200 OK. Responded in 6.642773ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/66/events/662"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/f28e4f21-3ac2-5963-a179-c91686baf6b4

---

Response status code: 204 No Content. Responded in 17.482875ms

## Get Opportunity Feed Items

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F89%2Fevents%2F897?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 20.740765ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-30T06:07:47+00:00",
    "endDate": "2020-09-30T09:48:47+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F66%2Fevents%2F662?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 13.17894ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/66",
      "name": "Frozen Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/66#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 6.71,
    ...
    "startDate": "2020-09-24T22:09:44+00:00",
    "endDate": "2020-09-25T01:39:44+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f28e4f21-3ac2-5963-a179-c91686baf6b4

---

Response status code: 200 OK. Responded in 85.73098ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f28e4f21-3ac2-5963-a179-c91686baf6b4",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/66"
        },
        "maximumAttendeeCapacity": 50,
        "remainingAttendeeCapacity": 50,
        "startDate": "2020-09-24T22:09:44+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f28e4f21-3ac2-5963-a179-c91686baf6b4

---

Response status code: 200 OK. Responded in 108.178133ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:44:12+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f28e4f21-3ac2-5963-a179-c91686baf6b4

---

Response status code: 200 OK. Responded in 68.096898ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f28e4f21-3ac2-5963-a179-c91686baf6b4",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f28e4f21-3ac2-5963-a179-c91686baf6b4#/orderedItems/73",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/89#/offers/0",
        "price": 3.88,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f28e4f21-3ac2-5963-a179-c91686baf6b4#/orderedItems/74",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/89#/offers/0",
        "price": 3.88,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f28e4f21-3ac2-5963-a179-c91686baf6b4#/orderedItems/75",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/66#/offers/0",
        "price": 6.71,
