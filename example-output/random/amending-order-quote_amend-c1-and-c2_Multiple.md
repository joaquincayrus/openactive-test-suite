[< Return to Summary](summary.md) | File Generated: Mon Sep 21 2020 21:38:54 GMT+0000 (Coordinated Universal Time)
...
⚠️ 20 passed with 0 failures, 351 warnings and 138 suggestions 
...
Response status code: 200 OK. Responded in 10.996488ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/14/events/147"
}
```
...
Response status code: 200 OK. Responded in 10.273644ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/60/events/609"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F14%2Fevents%2F147?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 44.194968ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/14",
      "name": "Cotton Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/14#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-09-30T03:08:11+00:00",
    "endDate": "2020-09-30T08:03:11+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F60%2Fevents%2F609?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 43.725039ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/60",
      "name": "Concrete Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/60#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 3.9,
    ...
    "startDate": "2020-09-23T05:00:33+00:00",
    "endDate": "2020-09-23T06:43:33+00:00"
  }
}
```
### Specs
...
## First Attempt - C1 -> C2 >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c51d80d5-3bcd-542a-8025-77e41e097bd0

---

Response status code: 200 OK. Responded in 64.212589ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c51d80d5-3bcd-542a-8025-77e41e097bd0",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/14"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3,
        "startDate": "2020-09-30T03:08:11+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/60"
        },
        "maximumAttendeeCapacity": 35,
        "remainingAttendeeCapacity": 35,
        "startDate": "2020-09-23T05:00:33+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c51d80d5-3bcd-542a-8025-77e41e097bd0

---

Response status code: 200 OK. Responded in 99.845003ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 8.668139ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/65/events/658"
}
```
...
Response status code: 200 OK. Responded in 7.752082ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/89/events/895"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F65%2Fevents%2F658?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 21.097311ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-24T21:13:57+00:00",
    "endDate": "2020-09-24T21:54:57+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F89%2Fevents%2F895?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 12.773694ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-28T04:03:13+00:00",
    "endDate": "2020-09-28T06:35:13+00:00"
  }
}
```
### Specs
...
## Second Attempt - C1 -> B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
Response status code: 200 OK. Responded in 94.499223ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 139.07757ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:43:59+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c51d80d5-3bcd-542a-8025-77e41e097bd0

---

Response status code: 200 OK. Responded in 132.286786ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c51d80d5-3bcd-542a-8025-77e41e097bd0",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c51d80d5-3bcd-542a-8025-77e41e097bd0#/orderedItems/34",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/65#/offers/0",
        "price": 1.7,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c51d80d5-3bcd-542a-8025-77e41e097bd0#/orderedItems/35",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/65#/offers/0",
        "price": 1.7,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c51d80d5-3bcd-542a-8025-77e41e097bd0#/orderedItems/36",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/89#/offers/0",
        "price": 3.88,
