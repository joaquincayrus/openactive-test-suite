[< Return to Summary](summary.md) | File Generated: Mon Sep 21 2020 21:39:01 GMT+0000 (Coordinated Universal Time)

# customer-requested-cancellation >> book-and-cancel (ScheduledSession)

Feature Implemented: true

A successful end to end booking including cancellation, including checking the Orders Feed.
...
Response status code: 200 OK. Responded in 44.404692ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/43/events/435"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/b6194508-359f-5c6d-a163-eb9f4d3c2961

---

Response status code: 204 No Content. Responded in 41.602345ms

## Get Opportunity Feed Items

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F43%2Fevents%2F435?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 18.729736ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-01T15:37:13+00:00",
    "endDate": "2020-10-01T21:20:13+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b6194508-359f-5c6d-a163-eb9f4d3c2961

---

Response status code: 200 OK. Responded in 66.539535ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b6194508-359f-5c6d-a163-eb9f4d3c2961",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/43"
        },
        "maximumAttendeeCapacity": 9,
        "remainingAttendeeCapacity": 9,
        "startDate": "2020-10-01T15:37:13+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b6194508-359f-5c6d-a163-eb9f4d3c2961

---

Response status code: 200 OK. Responded in 111.221792ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:44:02+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b6194508-359f-5c6d-a163-eb9f4d3c2961

---

Response status code: 200 OK. Responded in 82.59777ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b6194508-359f-5c6d-a163-eb9f4d3c2961",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b6194508-359f-5c6d-a163-eb9f4d3c2961#/orderedItems/39",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/43#/offers/0",
        "price": 0,
...
### get-order Request
GET http://localhost:3000/get-order/b6194508-359f-5c6d-a163-eb9f4d3c2961

---

Response status code: 200 OK. Responded in 2666.2602070000003ms
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "b6194508-359f-5c6d-a163-eb9f4d3c2961",
  "modified": 637363211429584000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/b6194508-359f-5c6d-a163-eb9f4d3c2961",
    "identifier": "b6194508-359f-5c6d-a163-eb9f4d3c2961",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/b6194508-359f-5c6d-a163-eb9f4d3c2961#/orderedItems/39",
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/b6194508-359f-5c6d-a163-eb9f4d3c2961

---

Response status code: 204 No Content. Responded in 318.129436ms
### Specs
* ✅ Orders feed result should have 1 orderedItem(s)
* ✅ Order Cancellation return 204 on success
* ✅ Orders feed should have CustomerCancelled as orderItemStatus

## Orders Feed >> validation of Orders feed
### Specs
* ✅ passes validation checks
