...
Response status code: 200 OK. Responded in 53.519545ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/52/events/523"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F52%2Fevents%2F523?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 6.110371ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/52",
      "name": "Rubber Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/52#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-09-25T18:13:26+00:00",
    "endDate": "2020-09-25T22:32:26+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8cc244d4-950a-5bde-b910-4f493fff7b03

---

Response status code: 200 OK. Responded in 74.624525ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8cc244d4-950a-5bde-b910-4f493fff7b03",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/52"
        },
        "maximumAttendeeCapacity": 11,
        "remainingAttendeeCapacity": 11,
        "startDate": "2020-09-25T18:13:26+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8cc244d4-950a-5bde-b910-4f493fff7b03

---

Response status code: 400 Bad Request. Responded in 64.017352ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 10.710045ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/44/events/444"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F44%2Fevents%2F444?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 8.886334ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-23T05:48:16+00:00",
    "endDate": "2020-09-23T10:50:16+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/045ffe84-35dd-5252-8782-f0eca97cefb2

---

Response status code: 200 OK. Responded in 49.629286ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/045ffe84-35dd-5252-8782-f0eca97cefb2",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/045ffe84-35dd-5252-8782-f0eca97cefb2

---

Response status code: 200 OK. Responded in 89.471383ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/045ffe84-35dd-5252-8782-f0eca97cefb2

---

Response status code: 400 Bad Request. Responded in 21.023664ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
