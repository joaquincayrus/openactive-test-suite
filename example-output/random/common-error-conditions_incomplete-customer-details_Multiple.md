...
⚠️ 17 passed with 0 failures, 263 warnings and 102 suggestions 
...
Response status code: 200 OK. Responded in 18.324402ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/42/events/429"
}
```
...
Response status code: 200 OK. Responded in 17.875475ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/56/events/564"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F42%2Fevents%2F429?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 17.186434ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-24T15:50:23+00:00",
    "endDate": "2020-09-24T20:17:23+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F56%2Fevents%2F564?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 16.182673ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-23T07:07:48+00:00",
    "endDate": "2020-09-23T07:39:48+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b4ad48e2-e259-5e21-b100-29f8f5a53f69

---

Response status code: 200 OK. Responded in 56.363464ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b4ad48e2-e259-5e21-b100-29f8f5a53f69",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/56"
        },
        "maximumAttendeeCapacity": 28,
        "remainingAttendeeCapacity": 28,
        "startDate": "2020-09-23T07:07:48+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b4ad48e2-e259-5e21-b100-29f8f5a53f69

---

Response status code: 400 Bad Request. Responded in 45.165896ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 6.112665ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/32/events/329"
}
```
...
Response status code: 200 OK. Responded in 5.479627ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/34/events/348"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F32%2Fevents%2F329?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 5.837649ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/32",
      "name": "Wooden Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/32#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 8.27,
    ...
    "startDate": "2020-09-22T05:32:52+00:00",
    "endDate": "2020-09-22T11:10:52+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F34%2Fevents%2F348?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 5.35912ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/34",
      "name": "Fresh Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/34#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 7.77,
    ...
    "startDate": "2020-09-28T07:40:51+00:00",
    "endDate": "2020-09-28T12:56:51+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/27d3f350-a3dd-5fed-82c4-60a3266d1bdd

---

Response status code: 200 OK. Responded in 44.043229ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/27d3f350-a3dd-5fed-82c4-60a3266d1bdd",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/32"
        },
        "maximumAttendeeCapacity": 19,
        "remainingAttendeeCapacity": 19,
        "startDate": "2020-09-22T05:32:52+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/34"
        },
        "maximumAttendeeCapacity": 49,
        "remainingAttendeeCapacity": 49,
        "startDate": "2020-09-28T07:40:51+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/27d3f350-a3dd-5fed-82c4-60a3266d1bdd

---

Response status code: 200 OK. Responded in 80.219851ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/27d3f350-a3dd-5fed-82c4-60a3266d1bdd

---

Response status code: 400 Bad Request. Responded in 61.395736ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
