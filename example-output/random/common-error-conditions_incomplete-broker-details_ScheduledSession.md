...
Response status code: 200 OK. Responded in 51.53275ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/71/events/713"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F71%2Fevents%2F713?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 11.351494ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-30T06:59:30+00:00",
    "endDate": "2020-09-30T09:34:30+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d36667ec-f28d-5494-a4b9-898f60829d7e

---

Response status code: 400 Bad Request. Responded in 38.58884ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 4.177253ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 7.286842ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-28T20:17:42+00:00",
    "endDate": "2020-09-28T21:42:42+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c6cf8cf0-3cd4-5a8c-a73e-570cb7adba14

---

Response status code: 200 OK. Responded in 73.303445ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c6cf8cf0-3cd4-5a8c-a73e-570cb7adba14",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c6cf8cf0-3cd4-5a8c-a73e-570cb7adba14

---

Response status code: 400 Bad Request. Responded in 62.898615ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
...
Response status code: 200 OK. Responded in 14.727993ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/79/events/793"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F79%2Fevents%2F793?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 3.637621ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-30T01:48:10+00:00",
    "endDate": "2020-09-30T06:14:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/564b5109-2e6c-504e-a514-6862ddd88add

---

Response status code: 200 OK. Responded in 109.54249ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/564b5109-2e6c-504e-a514-6862ddd88add",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/564b5109-2e6c-504e-a514-6862ddd88add

---

Response status code: 200 OK. Responded in 94.337175ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/564b5109-2e6c-504e-a514-6862ddd88add

---

Response status code: 400 Bad Request. Responded in 32.165835ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
