[< Return to Summary](summary.md) | File Generated: Mon Sep 21 2020 21:39:26 GMT+0000 (Coordinated Universal Time)
...
⚠️ 22 passed with 0 failures, 304 warnings and 120 suggestions 
...
Response status code: 200 OK. Responded in 56.424522ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/109/events/1009"
}
```
...
Response status code: 200 OK. Responded in 74.76864ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/110/events/1010"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F109%2Fevents%2F1009?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 251.933802ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/109/events/1009",
  "modified": 1600724369986,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/109/events/1009",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F110%2Fevents%2F1010?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 251.650988ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/110/events/1010",
  ...
  "data": {
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/110",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/110#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 14.99,
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d85856c8-f8e0-5624-a7b1-4bc57c44febf

---

Response status code: 200 OK. Responded in 26.726228ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d85856c8-f8e0-5624-a7b1-4bc57c44febf",
...
Response status code: 200 OK. Responded in 74.468102ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/118/events/1018"
}
```
...
Response status code: 200 OK. Responded in 45.981086ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/117/events/1017"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F118%2Fevents%2F1018?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 361.373864ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/118/events/1018",
  "modified": 1600724370916,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/118/events/1018",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/118",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/118#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 14.99,
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F117%2Fevents%2F1017?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 359.560573ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/117/events/1017",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d85856c8-f8e0-5624-a7b1-4bc57c44febf

---

Response status code: 200 OK. Responded in 131.439893ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/118"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10,
        "startDate": "2020-09-22T21:39:29+00:00",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d85856c8-f8e0-5624-a7b1-4bc57c44febf

---

Response status code: 200 OK. Responded in 45.53995ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d85856c8-f8e0-5624-a7b1-4bc57c44febf",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d85856c8-f8e0-5624-a7b1-4bc57c44febf#/orderedItems/94",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/118#/offers/0",
        "price": 14.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d85856c8-f8e0-5624-a7b1-4bc57c44febf#/orderedItems/95",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/118#/offers/0",
        "price": 14.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d85856c8-f8e0-5624-a7b1-4bc57c44febf#/orderedItems/96",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/117#/offers/0",
        "price": 14.99,
