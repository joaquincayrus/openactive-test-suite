...
Response status code: 200 OK. Responded in 41.989545ms
```json
{
...
Response status code: 200 OK. Responded in 20.629156ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 326.214384ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/157/events/1057",
...
Response status code: 200 OK. Responded in 315.830702ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/158/events/1058",
  "modified": 1600724383100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/158/events/1058",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/38a4957f-56da-5630-9cc4-9b4c66fc1e92

---

Response status code: 500 Internal Server Error. Responded in 68.204441ms
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/38a4957f-56da-5630-9cc4-9b4c66fc1e92

---

Response status code: 500 Internal Server Error. Responded in 71.016671ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "SellerMismatchError",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/38a4957f-56da-5630-9cc4-9b4c66fc1e92

---

Response status code: 500 Internal Server Error. Responded in 52.507218ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "SellerMismatchError",
