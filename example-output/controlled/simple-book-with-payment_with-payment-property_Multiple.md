[< Return to Summary](summary.md) | File Generated: Mon Sep 21 2020 21:39:38 GMT+0000 (Coordinated Universal Time)
...
⚠️ 9 passed with 0 failures, 198 warnings and 78 suggestions 
...
Response status code: 200 OK. Responded in 50.294442ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/154/events/1054"
}
```
...
Response status code: 200 OK. Responded in 49.866723ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/155/events/1055"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/b1d39aa6-ae33-5eaa-847a-680ab2f656d1

---

Response status code: 204 No Content. Responded in 64.901789ms

## Get Opportunity Feed Items

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F154%2Fevents%2F1054?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 216.799297ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/154/events/1054",
  "modified": 1600724381698,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/154/events/1054",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/154",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/154#/offers/0",
          "availableChannel": [
    ...
    "duration": "PT1H0.0000026S",
    "maximumAttendeeCapacity": 10,
    "remainingAttendeeCapacity": 10,
    "startDate": "2020-09-22T21:39:40+00:00",
    "endDate": "2020-09-22T22:39:40+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F155%2Fevents%2F1055?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 216.397178ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/155/events/1055",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b1d39aa6-ae33-5eaa-847a-680ab2f656d1

---

Response status code: 200 OK. Responded in 118.193485ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b1d39aa6-ae33-5eaa-847a-680ab2f656d1",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/154"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10,
        "startDate": "2020-09-22T21:39:40+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b1d39aa6-ae33-5eaa-847a-680ab2f656d1

---

Response status code: 200 OK. Responded in 97.549418ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:44:41+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b1d39aa6-ae33-5eaa-847a-680ab2f656d1

---

Response status code: 200 OK. Responded in 57.786677ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b1d39aa6-ae33-5eaa-847a-680ab2f656d1",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b1d39aa6-ae33-5eaa-847a-680ab2f656d1#/orderedItems/147",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/154#/offers/0",
        "price": 14.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b1d39aa6-ae33-5eaa-847a-680ab2f656d1#/orderedItems/148",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/154#/offers/0",
        "price": 14.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b1d39aa6-ae33-5eaa-847a-680ab2f656d1#/orderedItems/149",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/155#/offers/0",
        "price": 14.99,
