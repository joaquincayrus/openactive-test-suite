[< Return to Summary](summary.md) | File Generated: Mon Sep 21 2020 21:39:33 GMT+0000 (Coordinated Universal Time)

# common-error-conditions >> incomplete-customer-details (Multiple)
...
⚠️ 17 passed with 0 failures, 257 warnings and 102 suggestions 
...
Response status code: 200 OK. Responded in 28.628572ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/138/events/1038"
}
```
...
Response status code: 200 OK. Responded in 31.957332ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/139/events/1039"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F138%2Fevents%2F1038?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 165.427929ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/138/events/1038",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F139%2Fevents%2F1039?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 164.997709ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/139/events/1039",
  "modified": 1600724376613,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/139/events/1039",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/139",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/139#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 14.99,
...
## Incomplete Customer Details at C2 >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Incomplete Customer Details at C2 >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a184817f-1fea-5450-8128-866b6ab1cf03

---

Response status code: 200 OK. Responded in 25.814038ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a184817f-1fea-5450-8128-866b6ab1cf03",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a184817f-1fea-5450-8128-866b6ab1cf03

---

Response status code: 400 Bad Request. Responded in 39.093063ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 18.03176ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/140/events/1040"
}
```
...
Response status code: 200 OK. Responded in 19.135512ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/141/events/1041"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F140%2Fevents%2F1040?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 467.488976ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/140/events/1040",
  "modified": 1600724377684,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/140/events/1040",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/140",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/140#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 14.99,
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F141%2Fevents%2F1041?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 467.028954ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/141/events/1041",
...
## Incomplete Customer Details at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Incomplete Customer Details at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8aa5a647-aee2-5061-b1c7-7dbf288e1976

---

Response status code: 200 OK. Responded in 40.439526ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8aa5a647-aee2-5061-b1c7-7dbf288e1976",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/140"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10,
        "startDate": "2020-09-22T21:39:36+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8aa5a647-aee2-5061-b1c7-7dbf288e1976

---

Response status code: 200 OK. Responded in 130.357876ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/8aa5a647-aee2-5061-b1c7-7dbf288e1976

---

Response status code: 400 Bad Request. Responded in 31.793706ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
