[< Return to Summary](summary.md) | File Generated: Mon Sep 21 2020 21:39:37 GMT+0000 (Coordinated Universal Time)
...
Response status code: 200 OK. Responded in 64.740767ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/145/events/1045"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F145%2Fevents%2F1045?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 568.069311ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/145/events/1045",
  "modified": 1600724378882,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/145/events/1045",
    ...
    "startDate": "2020-09-22T21:39:37+00:00",
    "endDate": "2020-09-22T22:39:37+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f90af02b-e19e-5ec1-9f15-b8a7ec744825

---

Response status code: 200 OK. Responded in 44.686505ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f90af02b-e19e-5ec1-9f15-b8a7ec744825",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f90af02b-e19e-5ec1-9f15-b8a7ec744825

---

Response status code: 200 OK. Responded in 128.720063ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:44:38+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f90af02b-e19e-5ec1-9f15-b8a7ec744825

---

Response status code: 400 Bad Request. Responded in 24.687663ms
```json
{
  "@context": "https://openactive.io/",
