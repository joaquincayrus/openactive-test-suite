...
# availability-check >> opportunity-full (Multiple)
...
⚠️ 14 passed with 0 failures, 159 warnings and 60 suggestions 
...
Response status code: 200 OK. Responded in 21.954706ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/159/events/1059"
}
```
...
Response status code: 200 OK. Responded in 22.48583ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/160/events/1060"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F159%2Fevents%2F1059?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 484.361486ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/159/events/1059",
  "modified": 1600724384645,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/159/events/1059",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/159",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/159#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-09-22T21:39:43+00:00",
    "endDate": "2020-09-22T22:39:43+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F160%2Fevents%2F1060?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 483.78256ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/160/events/1060",
  ...
  "data": {
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/160",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/160#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 14.99,
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2c7fa5ad-1ba3-5ba8-a10c-c271d5d9ef06

---

Response status code: 409 Conflict. Responded in 47.815184ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2c7fa5ad-1ba3-5ba8-a10c-c271d5d9ef06",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/159"
        },
        "maximumAttendeeCapacity": 0,
        "remainingAttendeeCapacity": 0,
        "startDate": "2020-09-22T21:39:43+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/160"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10,
        "startDate": "2020-09-22T21:39:43+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2c7fa5ad-1ba3-5ba8-a10c-c271d5d9ef06

---

Response status code: 409 Conflict. Responded in 66.420326ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:44:44+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
 ...
 * ⚠️ $.orderedItem[1].error[0].description: Recommended property `description` is missing from `OpportunityIsFullError`.
 * ⚠️ $.orderedItem[1].error[0].instance: Recommended property `instance` is missing from `OpportunityIsFullError`.
 * ⚠️ $.orderedItem[1].error[1].instance: Recommended property `instance` is missing from `OpportunityIntractableError`.
 * ⚠️ $.orderedItem[1].orderedItem.eventStatus: Recommended property `eventStatus` is missing from `ScheduledSession`.
 * ⚠️ $.orderedItem[1].orderedItem.superEvent.ageRange: Recommended property `ageRange` is missing from `SessionSeries`.
 * ⚠️ $.orderedItem[1].orderedItem.superEvent.genderRestriction: Recommended property `genderRestriction` is missing from `SessionSeries`.
 * ⚠️ $.orderedItem[1].orderedItem.superEvent.eventStatus: Recommended property `eventStatus` is missing from `SessionSeries`.
