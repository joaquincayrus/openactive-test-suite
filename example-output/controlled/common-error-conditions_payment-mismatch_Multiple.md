...
# common-error-conditions >> payment-mismatch (Multiple)
...
⚠️ 9 passed with 0 failures, 151 warnings and 60 suggestions 
...
Response status code: 200 OK. Responded in 21.749224ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/148/events/1048"
}
```
...
Response status code: 200 OK. Responded in 24.549356ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/149/events/1049"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F148%2Fevents%2F1048?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 417.393402ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/148/events/1048",
  "modified": 1600724380221,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/148/events/1048",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/148",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/148#/offers/0",
          "availableChannel": [
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F149%2Fevents%2F1049?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 416.920279ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/149/events/1049",
...
## Total Payment Due mismatch at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookablePaid' required for this test
...
## Total Payment Due mismatch at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/04997415-c905-5d1c-88f1-c1daf3e01abc

---

Response status code: 200 OK. Responded in 51.544914ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/04997415-c905-5d1c-88f1-c1daf3e01abc",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/148"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10,
        "startDate": "2020-09-22T21:39:38+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/04997415-c905-5d1c-88f1-c1daf3e01abc

---

Response status code: 200 OK. Responded in 162.400895ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/04997415-c905-5d1c-88f1-c1daf3e01abc

---

Response status code: 400 Bad Request. Responded in 72.027255ms
```json
{
  "@context": "https://openactive.io/",
