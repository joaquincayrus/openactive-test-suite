...
Response status code: 200 OK. Responded in 14.436696ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/134/events/1034"
}
```
...
Response status code: 200 OK. Responded in 19.400935ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/135/events/1035"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F134%2Fevents%2F1034?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 301.260408ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/134/events/1034",
  "modified": 1600724376064,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/134/events/1034",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/134",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/134#/offers/0",
          "availableChannel": [
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F135%2Fevents%2F1035?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 300.726082ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/135/events/1035",
  ...
  "data": {
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/135",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Free Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/135#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 0,
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c12386f3-048d-51ae-9b0b-c7445f1a2917

---

Response status code: 200 OK. Responded in 29.570018ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c12386f3-048d-51ae-9b0b-c7445f1a2917",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/134"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10,
        "startDate": "2020-09-22T21:39:34+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c12386f3-048d-51ae-9b0b-c7445f1a2917

---

Response status code: 200 OK. Responded in 85.95262ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c12386f3-048d-51ae-9b0b-c7445f1a2917

---

Response status code: 400 Bad Request. Responded in 57.461454ms
```json
{
  "@context": "https://openactive.io/",
