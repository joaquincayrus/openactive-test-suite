...
⚠️ 9 passed with 0 failures, 95 warnings and 34 suggestions 
...
Response status code: 200 OK. Responded in 71.631474ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/129/events/1029"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F129%2Fevents%2F1029?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 231.847846ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/129/events/1029",
  "modified": 1600724374987,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/129/events/1029",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/129",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/129#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-09-22T21:39:33+00:00",
    "endDate": "2020-09-22T22:39:33+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/547f095c-9a76-53a4-aa46-7bf413bebb0f

---

Response status code: 200 OK. Responded in 27.547828ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/547f095c-9a76-53a4-aa46-7bf413bebb0f",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/129"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10,
        "startDate": "2020-09-22T21:39:33+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/547f095c-9a76-53a4-aa46-7bf413bebb0f

---

Response status code: 400 Bad Request. Responded in 44.259034ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 22.630491ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/133/events/1033"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F133%2Fevents%2F1033?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 498.323327ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/133/events/1033",
  ...
  "data": {
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/133",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/133#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 14.99,
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7619f5ef-c5fc-5d17-aa81-00d3a0090b02

---

Response status code: 200 OK. Responded in 24.985498ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7619f5ef-c5fc-5d17-aa81-00d3a0090b02",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/133"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10,
        "startDate": "2020-09-22T21:39:34+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7619f5ef-c5fc-5d17-aa81-00d3a0090b02

---

Response status code: 200 OK. Responded in 40.46444ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:44:35+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7619f5ef-c5fc-5d17-aa81-00d3a0090b02

---

Response status code: 400 Bad Request. Responded in 12.633305ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
