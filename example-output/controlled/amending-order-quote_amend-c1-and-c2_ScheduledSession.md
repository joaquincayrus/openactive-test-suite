...
# amending-order-quote >> amend-c1-and-c2 (ScheduledSession)
...
⚠️ 10 passed with 0 failures, 129 warnings and 46 suggestions 
...
Response status code: 200 OK. Responded in 337.32299ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/103/events/1003"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F103%2Fevents%2F1003?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 433.486862ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/103/events/1003",
  "modified": 1600724367975,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/103/events/1003",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/103",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/103#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-09-22T21:39:26+00:00",
    "endDate": "2020-09-22T22:39:26+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0f6be175-27a9-56f0-94b0-04d10abf4223

---

Response status code: 200 OK. Responded in 97.318499ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0f6be175-27a9-56f0-94b0-04d10abf4223",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0f6be175-27a9-56f0-94b0-04d10abf4223

---

Response status code: 200 OK. Responded in 64.589952ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:44:27+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
Response status code: 200 OK. Responded in 11.263067ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/108/events/1008"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F108%2Fevents%2F1008?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 475.379597ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/108/events/1008",
  "modified": 1600724369430,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/108/events/1008",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/108",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/108#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 14.99,
    ...
    "duration": "PT1H0.0000025S",
    "maximumAttendeeCapacity": 10,
    "remainingAttendeeCapacity": 10,
    "startDate": "2020-09-22T21:39:27+00:00",
    "endDate": "2020-09-22T22:39:27+00:00"
  }
}
```
### Specs
...
Response status code: 200 OK. Responded in 67.702987ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 62.094406ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:44:28+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/0f6be175-27a9-56f0-94b0-04d10abf4223

---

Response status code: 200 OK. Responded in 31.401161ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/0f6be175-27a9-56f0-94b0-04d10abf4223",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0f6be175-27a9-56f0-94b0-04d10abf4223#/orderedItems/84",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/108#/offers/0",
        "price": 14.99,
