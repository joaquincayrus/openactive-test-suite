[< Return to Summary](summary.md) | File Generated: Mon Sep 21 2020 21:39:41 GMT+0000 (Coordinated Universal Time)
...
⚠️ 6 passed with 0 failures, 60 warnings and 20 suggestions 
...
Response status code: 200 OK. Responded in 91.644245ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/156/events/1056"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F156%2Fevents%2F1056?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 436.982913ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/156/events/1056",
  "modified": 1600724383098,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/156/events/1056",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/156",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/156#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-09-22T21:39:41+00:00",
    "endDate": "2020-09-22T22:39:41+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f55b35bb-b079-55ee-8899-0edd7a3adeb3

---

Response status code: 409 Conflict. Responded in 77.565672ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f55b35bb-b079-55ee-8899-0edd7a3adeb3",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/156"
        },
        "maximumAttendeeCapacity": 0,
        "remainingAttendeeCapacity": 0,
        "startDate": "2020-09-22T21:39:41+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f55b35bb-b079-55ee-8899-0edd7a3adeb3

---

Response status code: 409 Conflict. Responded in 44.627155ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:44:42+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
