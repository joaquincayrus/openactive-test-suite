...
Response status code: 200 OK. Responded in 61.947523ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/127/events/1027"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/71fe3075-ce81-58b5-aa2f-f5eaf8173917

---

Response status code: 204 No Content. Responded in 14.295982ms

## Get Opportunity Feed Items

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F127%2Fevents%2F1027?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 303.950982ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/127/events/1027",
  ...
  "data": {
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/127",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/127#/offers/0",
          "availableChannel": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/71fe3075-ce81-58b5-aa2f-f5eaf8173917

---

Response status code: 200 OK. Responded in 54.111324ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/71fe3075-ce81-58b5-aa2f-f5eaf8173917",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/127"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10,
        "startDate": "2020-09-22T21:39:32+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/71fe3075-ce81-58b5-aa2f-f5eaf8173917

---

Response status code: 200 OK. Responded in 70.792934ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:44:33+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/71fe3075-ce81-58b5-aa2f-f5eaf8173917

---

Response status code: 200 OK. Responded in 31.666836ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/71fe3075-ce81-58b5-aa2f-f5eaf8173917",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/71fe3075-ce81-58b5-aa2f-f5eaf8173917#/orderedItems/113",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/127#/offers/0",
        "price": 14.99,
...
### get-order Request
GET http://localhost:3000/get-order/71fe3075-ce81-58b5-aa2f-f5eaf8173917

---

Response status code: 200 OK. Responded in 2387.5817349999998ms
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "71fe3075-ce81-58b5-aa2f-f5eaf8173917",
  "modified": 637363211740168600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/71fe3075-ce81-58b5-aa2f-f5eaf8173917",
    "identifier": "71fe3075-ce81-58b5-aa2f-f5eaf8173917",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/71fe3075-ce81-58b5-aa2f-f5eaf8173917#/orderedItems/113",
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/71fe3075-ce81-58b5-aa2f-f5eaf8173917

---

Response status code: 204 No Content. Responded in 46.562552ms
### Specs
