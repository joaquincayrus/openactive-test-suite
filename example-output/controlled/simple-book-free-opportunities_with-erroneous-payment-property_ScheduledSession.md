...
# simple-book-free-opportunities >> with-erroneous-payment-property (ScheduledSession)
...
⚠️ 6 passed with 0 failures, 58 warnings and 20 suggestions 
...
Response status code: 200 OK. Responded in 41.833629ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/130/events/1030"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F130%2Fevents%2F1030?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 403.100257ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/130/events/1030",
  "modified": 1600724375331,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/130/events/1030",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/130",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/130#/offers/0",
          "availableChannel": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b531fb1d-6424-5c13-a64c-6ee067c5520e

---

Response status code: 200 OK. Responded in 23.296523ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b531fb1d-6424-5c13-a64c-6ee067c5520e",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/130"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10,
        "startDate": "2020-09-22T21:39:33+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b531fb1d-6424-5c13-a64c-6ee067c5520e

---

Response status code: 200 OK. Responded in 29.322314ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-21T21:44:34+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b531fb1d-6424-5c13-a64c-6ee067c5520e

---

Response status code: 400 Bad Request. Responded in 24.530283ms
```json
{
  "@context": "https://openactive.io/",
