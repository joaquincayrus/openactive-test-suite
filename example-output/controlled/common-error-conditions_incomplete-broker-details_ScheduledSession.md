[< Return to Summary](summary.md) | File Generated: Mon Sep 21 2020 21:39:32 GMT+0000 (Coordinated Universal Time)
...
Response status code: 200 OK. Responded in 82.625832ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/125/events/1025"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F125%2Fevents%2F1025?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 84.747936ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/125/events/1025",
  "modified": 1600724373362,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/125/events/1025",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/125",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/125#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-09-22T21:39:32+00:00",
    "endDate": "2020-09-22T22:39:32+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/04666438-f14b-5c01-907c-c182d8e9d3d8

---

Response status code: 400 Bad Request. Responded in 36.654189ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 30.955111ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/126/events/1026"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F126%2Fevents%2F1026?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 446.120321ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/126/events/1026",
  "modified": 1600724374168,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/126/events/1026",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/126",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/126#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 14.99,
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a3ba4152-b5bd-5c98-ab5c-be4e259908b5

---

Response status code: 200 OK. Responded in 39.423713ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a3ba4152-b5bd-5c98-ab5c-be4e259908b5",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/126"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10,
        "startDate": "2020-09-22T21:39:32+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a3ba4152-b5bd-5c98-ab5c-be4e259908b5

---

Response status code: 400 Bad Request. Responded in 42.188346ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
...
Response status code: 200 OK. Responded in 28.346275ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/128/events/1028"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F128%2Fevents%2F1028?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 278.568412ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/128/events/1028",
  "modified": 1600724374986,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/128/events/1028",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/128",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/128#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 14.99,
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/201ddbbc-463a-5717-9cb0-28a9803bac0c

---

Response status code: 200 OK. Responded in 31.060297ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/201ddbbc-463a-5717-9cb0-28a9803bac0c",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/201ddbbc-463a-5717-9cb0-28a9803bac0c

---

Response status code: 200 OK. Responded in 45.180478ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/201ddbbc-463a-5717-9cb0-28a9803bac0c

---

Response status code: 400 Bad Request. Responded in 62.091694ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
