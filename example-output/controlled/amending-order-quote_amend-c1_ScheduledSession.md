...
# amending-order-quote >> amend-c1 (ScheduledSession)
...
⚠️ 11 passed with 0 failures, 112 warnings and 40 suggestions 
...
Response status code: 200 OK. Responded in 304.840244ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/101/events/1001"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F101%2Fevents%2F1001?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 515.609623ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/101/events/1001",
  "modified": 1600724367974,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/101/events/1001",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/101",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/101#/offers/0",
          "availableChannel": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f2b1b49f-cc5d-5661-9a0b-e22331b26c9f

---

Response status code: 200 OK. Responded in 74.805666ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f2b1b49f-cc5d-5661-9a0b-e22331b26c9f",
...
Response status code: 200 OK. Responded in 21.974907ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/106/events/1006"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F106%2Fevents%2F1006?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 258.269671ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/106/events/1006",
  "modified": 1600724369098,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/106/events/1006",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/106",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/106#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 14.99,
...
Response status code: 200 OK. Responded in 43.050054ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f2b1b49f-cc5d-5661-9a0b-e22331b26c9f

---

Response status code: 200 OK. Responded in 68.953549ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f2b1b49f-cc5d-5661-9a0b-e22331b26c9f

---

Response status code: 200 OK. Responded in 118.14711ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f2b1b49f-cc5d-5661-9a0b-e22331b26c9f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f2b1b49f-cc5d-5661-9a0b-e22331b26c9f#/orderedItems/82",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/106#/offers/0",
        "price": 14.99,
